...
export function usePanBy(map: ShallowRef<Nullable<Map>>, options?: AnimationOptions & { offset: PointLike }) {
...
export function usePanTo(map: ShallowRef<Nullable<Map>>, options?: AnimationOptions & { lnglat: LngLatLike }) {
