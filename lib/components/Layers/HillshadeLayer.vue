<script lang="ts">
import type { AnyLayout, Expression, HillshadeLayout, HillshadePaint, MapLayerEventType, MapLayerMouseEvent, MapLayerTouchEvent } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: HillshadeLayout & HillshadePaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateHillshadeLayer({
	map: mapInstance,
