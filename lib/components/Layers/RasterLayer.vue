<script lang="ts">
import type { Expression, RasterLayout, RasterPaint, MapLayerEventType, MapLayerMouseEvent, MapLayerTouchEvent, AnyLayout } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: RasterLayout & RasterPaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateRasterLayer({
	map: mapInstance,
