<script lang="ts">
import type { AnyLayout, Expression, LineLayout, LinePaint, MapLayerEventType, MapLayerMouseEvent, MapLayerTouchEvent } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: LineLayout & LinePaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateLineLayer({
	map: mapInstance,
