...
import type { Map, LngLatBoundsLike, FitBoundsOptions, CameraOptions } from 'mapbox-gl'
...
export function useCameraForBounds(map: ShallowRef<Nullable<Map>>, options?: CameraOptions & { bounds: LngLatBoundsLike }) {
