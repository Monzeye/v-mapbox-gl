<script lang="ts">
import type { Expression, SkyLayout, SkyPaint, MapLayerEventType, MapLayerMouseEvent, MapLayerTouchEvent, AnyLayout } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: SkyLayout & SkyPaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateSkyLayer({
	map: mapInstance,
