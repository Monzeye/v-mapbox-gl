...
export function useZoomTo(map: ShallowRef<Nullable<Map>>, options?: AnimationOptions & { zoom: number }) {
...
export function useZoomIn(map: ShallowRef<Nullable<Map>>, options?: AnimationOptions) {
  ...
  function zoomIn(zoomVal: number, options?: AnimationOptions) {
    if (options) aimationOptions.value = options;
  }
  return {
    zoomIn,
...
export function useZoomOut(map: ShallowRef<Nullable<Map>>, options?: AnimationOptions) {
  ...
  function zoomOut(zoomVal: number, options?: AnimationOptions) {
    if (options) aimationOptions.value = options;
  }
  return {
    zoomOut,
