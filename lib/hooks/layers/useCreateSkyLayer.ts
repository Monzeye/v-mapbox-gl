import type { Map, Expression, AnySourceData, SkyLayer, SkyLayout, SkyPaint, SkyLayerStyle } from 'mapbox-gl'
...
const paintDefault: Paint = {
  ...
  'sky-gradient': ["interpolate", ["linear"], ["sky-radial-progress"], 0.8, "#87ceeb", 1, "white"],
