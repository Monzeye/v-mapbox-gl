<script lang="ts">
import type { AnyLayout, Expression, HeatmapLayout, HeatmapPaint, MapLayerEventType, MapLayerMouseEvent, MapLayerTouchEvent } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: HeatmapLayout & HeatmapPaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateHeatmapLayer({
	map: mapInstance,
