<script lang="ts">
import type { Expression, CircleLayout, CirclePaint, MapLayerTouchEvent, MapLayerMouseEvent, MapLayerEventType, AnyLayout } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: CircleLayout & CirclePaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateCircleLayer({
	map: mapInstance,
