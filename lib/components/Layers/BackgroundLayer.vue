<script lang="ts">
import type { Expression, BackgroundLayout, BackgroundPaint, MapLayerMouseEvent, MapLayerTouchEvent, MapLayerEventType, AnyLayout } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: BackgroundLayout & BackgroundPaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateBackgroundLayer({
	map: mapInstance,
