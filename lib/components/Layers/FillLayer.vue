<script lang="ts">
import type { AnyLayout, Expression, FillLayout, FillPaint, MapLayerEventType, MapLayerMouseEvent, MapLayerTouchEvent } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: FillLayout & FillPaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateFillLayer({
	map: mapInstance,
