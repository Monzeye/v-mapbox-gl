<script lang="ts">
import type { AnyLayout, Expression, FillExtrusionLayout, FillExtrusionPaint, MapLayerEventType, MapLayerMouseEvent, MapLayerTouchEvent } from 'mapbox-gl';
interface LayerProps {
	id?: string;
	filter?: Expression;
	style?: FillExtrusionLayout & FillExtrusionPaint;
	maxzoom?: number;
	minzoom?: number;
	metadata?: object;
...
const { getLayer, setBeforeId, setFilter, setStyle, setZoomRange, setLayoutProperty } = useCreateFillExtrusionLayer({
	map: mapInstance,
